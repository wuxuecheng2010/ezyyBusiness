...
public interface TbCustomerMapper {
	...
	String SELECT_FIELDS="icustomerid,vccustomername,vclinkman,vclinkphone,vczipcode,isalerid,vcregisteredaddress,vcaddress,vcstoreaddress,flaglock,numcreditdays,numcreditdays1,numcreditdays2,numcreditdays3,numcreditmoney,vccustomercode,icredittype,icustomerkindid";
